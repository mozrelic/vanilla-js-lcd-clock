...
class InitView {
  checkIfLoaded() {
    ...
    const clockDigits = this.generateMarkup();
    ...
    const observerCallback = (mutationList, observer) => {
      if (mutationList.length > 0) {
        ...
        completeElementArray.forEach((el) =>
          el.insertAdjacentHTML('afterbegin', clockDigits)
        );

        console.log(completeElementArray);
        observer.disconnect();
      }
    };
...
L32.2,39.7C31.6,39.6,30.9,39.6,30.3,39.5z M36.1,39.4L47.2,16c0.3,0.7,0.6,1.4,0.9,2.1l-9.9,20.8C37.5,39.1,36.8,39.3,36.1,39.4z"
        ...
        <div class="clock-meta-container">
          <section class="svg day">
            <div class="meta-title">Day</div>
          </section>
          <!-- end day container-->

          <section class="svg month">
            <div class="meta-title">Month</div>
          </section>
          <!-- end month container-->

          <section class="svg year">
